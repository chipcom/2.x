...
function hodotajstvoXLS(name) 
  ...
  format_top3    = lxw_workbook_add_format(workbook)
  lxw_format_set_bold(format_top3)
  lxw_format_set_font_size(format_top3, 11)
  lxw_format_set_num_format(format_top3, 'dd/mm/yyyy')
  ...
  // lxw_worksheet_merge_range(worksheet, 3, 3, 3, 19, HB_STOT(DToS(sys_date)), format_top3)
  lxw_worksheet_merge_range(worksheet, 3, 3, 3, 19, full_date(sys_date), format_top3)
  ...
  lxw_worksheet_set_column(worksheet, 10, 10, 8.0)
  lxw_worksheet_set_column(worksheet, 11, 11, 6.14)
  lxw_worksheet_set_column(worksheet, 12, 12, 11.86)
  lxw_worksheet_set_column(worksheet, 13, 13, 4.71)
  lxw_worksheet_set_column(worksheet, 14, 14, 9.86)
  lxw_worksheet_set_column(worksheet, 15, 15, 4.71)
  lxw_worksheet_set_column(worksheet, 16, 16, 10.86)
  lxw_worksheet_set_column(worksheet, 17, 17, 5.71)
  lxw_worksheet_set_column(worksheet, 18, 18, 12.0)
  lxw_worksheet_set_column(worksheet, 19, 19, 8.0)
