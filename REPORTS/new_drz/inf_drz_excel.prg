...
// 14.11.24 Итоги за период времени по диспансеризации репродуктивного здоровья МИАЦ
Function inf_drz_excel( file_name, arr_m, arr, arr_1, tcount_uch  )
  local workbook, worksheet, analiz, ws2511, ws2517
...
//    FORMAT_SET_BOLD( cell_format_woman )
    ...
    for i := 1 to 25
      WORKSHEET_WRITE_STRING( worksheet, 9, i - 1, alltrim( str( i ) ), form_text_header )
    next
    ...
    worksheet_write_formula( worksheet, 10, 16, '=H11', cell_format_plan )

    WORKSHEET_WRITE_NUMBER( worksheet, 10, 17, arr[ 1, 9 ], cell_format )
    WORKSHEET_WRITE_NUMBER( worksheet, 10, 18, arr[ 1, 10 ], cell_format )
    ...
    worksheet_write_formula( worksheet, 11, 16, '=H12', cell_format_plan )

    WORKSHEET_WRITE_NUMBER( worksheet, 11, 17, arr[ 2, 9 ], cell_format )
    WORKSHEET_WRITE_NUMBER( worksheet, 11, 18, arr[ 2, 10 ], cell_format )
    ...
    WORKSHEET_WRITE_NUMBER( worksheet, 12, 17, arr[ 3, 9 ], cell_format )
    WORKSHEET_WRITE_NUMBER( worksheet, 12, 18, arr[ 3, 10 ], cell_format )
    ...
    WORKSHEET_WRITE_NUMBER( worksheet, 13, 17, arr[ 4, 9 ], cell_format )
    WORKSHEET_WRITE_NUMBER( worksheet, 13, 18, arr[ 4, 10 ], cell_format )
    ...
    worksheet_write_formula( worksheet, 14, 8, '=E11+E13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 9, '=F11+F13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 10, '=G11+G13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 11, '=H11+H13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 12, '=I13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 13, '=J13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 14, '=K13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 15, '=L13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 16, '=M11', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 17, '=N11+N13', cell_format_itog )
    worksheet_write_formula( worksheet, 14, 18, '=O11+O13', cell_format_itog )
    ...
    worksheet_write_formula( worksheet, 15, 8, '=E12+E14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 9, '=F12+F14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 10, '=G12+G14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 11, '=H12+H14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 12, '=I14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 13, '=J14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 14, '=K14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 15, '=L14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 16, '=M12', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 17, '=N12+N14', cell_format_itog )
    worksheet_write_formula( worksheet, 15, 18, '=O12+O14', cell_format_itog )
