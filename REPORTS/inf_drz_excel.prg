...
Function inf_drz_excel( file_name, arr_m, arr, arr_1, tcount_uch, mas_rez_w, mas_rez_M  )
  ...
  If ! ISNIL( arr_m )
    ...
    worksheet_write_string( wsFemale, 34, 2, lstr(mas_rez_w[25]), form_text_add2 )
    worksheet_write_string( wsFemale, 35, 2, lstr(mas_rez_w[26]), form_text_add2 )
    worksheet_write_string( wsFemale, 36, 2, lstr(mas_rez_w[27]), form_text_add2 )
    worksheet_write_string( wsFemale, 37, 2, lstr(mas_rez_w[28]), form_text_add2 )
    worksheet_write_string( wsFemale, 38, 2, lstr(mas_rez_w[29]), form_text_add2 )
    worksheet_write_string( wsFemale, 39, 2, lstr(mas_rez_w[30]), form_text_add2 )
    worksheet_write_string( wsFemale, 40, 2, lstr(mas_rez_w[31]), form_text_add2 )
    ...
    worksheet_write_string( wsFemale, 47, 2, lstr(mas_rez_w[38]), form_text_add2 )
    worksheet_write_string( wsFemale, 48, 2, lstr(mas_rez_w[39]), form_text_add2 )
    worksheet_write_string( wsFemale, 49, 2, lstr(mas_rez_w[40]), form_text_add2 )
    worksheet_write_string( wsFemale, 50, 2, lstr(mas_rez_w[41]), form_text_add2 )
    worksheet_write_string( wsFemale, 51, 2, lstr(mas_rez_w[42]), form_text_add2 )
    worksheet_write_string( wsFemale, 52, 2, lstr(mas_rez_w[43]), form_text_add2 )
    worksheet_write_string( wsFemale, 53, 2, lstr(mas_rez_w[44]), form_text_add2 )
    worksheet_write_string( wsFemale, 54, 2, lstr(mas_rez_w[45]), form_text_add2 )
    worksheet_write_string( wsFemale, 55, 2, lstr(mas_rez_w[46]), form_text_add2 )
    worksheet_write_string( wsFemale, 56, 2, lstr(mas_rez_w[47]), form_text_add2 )
    worksheet_write_string( wsFemale, 57, 2, lstr(mas_rez_w[48]), form_text_add2 )
    worksheet_write_string( wsFemale, 58, 2, lstr(mas_rez_w[49]), form_text_add2 )
    worksheet_write_string( wsFemale, 59, 2, lstr(mas_rez_w[50]), form_text_add2 )
    worksheet_write_string( wsFemale, 60, 2, lstr(mas_rez_w[51]), form_text_add2 )
    worksheet_write_string( wsFemale, 61, 2, lstr(mas_rez_w[52]), form_text_add2 )
    ...
    worksheet_write_string( wsFemale, 68, 2, lstr(mas_rez_w[59]), form_text_add2 )
    worksheet_write_string( wsFemale, 69, 2, lstr(mas_rez_w[60]), form_text_add2 )
    worksheet_write_string( wsFemale, 70, 2, lstr(mas_rez_w[61]), form_text_add2 )
    worksheet_write_string( wsFemale, 71, 2, lstr(mas_rez_w[62]), form_text_add2 )
    worksheet_write_string( wsFemale, 72, 2, lstr(mas_rez_w[63]), form_text_add2 )
    worksheet_write_string( wsFemale, 73, 2, lstr(mas_rez_w[64]), form_text_add2 )
    worksheet_write_string( wsFemale, 74, 2, lstr(mas_rez_w[65]), form_text_add2 )
    ...
    worksheet_write_string( wsMan, 16, 2, lstr(mas_rez_m[8]), form_text_add2 )
    worksheet_write_string( wsMan, 17, 2, lstr(mas_rez_m[9]), form_text_add2 )
    worksheet_write_string( wsMan, 18, 2, lstr(mas_rez_m[10]), form_text_add2 )
    worksheet_write_string( wsMan, 19, 2, lstr(mas_rez_m[11]), form_text_add2 )
    ...
    worksheet_write_string( wsMan, 30, 2, lstr(mas_rez_m[22]), form_text_add2 )
    worksheet_write_string( wsMan, 31, 2, lstr(mas_rez_m[23]), form_text_add2 )
    worksheet_write_string( wsMan, 32, 2, lstr(mas_rez_m[24]), form_text_add2 )
    worksheet_write_string( wsMan, 33, 2, lstr(mas_rez_m[25]), form_text_add2 )
