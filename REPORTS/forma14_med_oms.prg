...
Function forma14_med_oms()
  ...
  ////////////////////////////////////////////////////////////////////
  arr_m := {2024, 1, 9, 'за январь - сентябрь 2024 года', 0d20240101, 0d20240930}  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ////////////////////////////////////////////////////////////////////
  ...
  //
  ////////////////////////////////////////////////////////////////////
  mdate_rak := arr_m[6] + 11 // по какую дату РАК сумма к оплате 11.10.24    Основание - письмо  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ////////////////////////////////////////////////////////////////////
  ...
  do while !eof()
    ...
    if schet_->IS_DOPLATA == 0 .and. !empty(val(schet_->smo)) .and. schet_->NREGISTR == 0 // только зарегистрированные
      ...
      //
      // 2024 год
        k := 7 // дата регистрации по 7.10.24 // Основание - письмо!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      //
