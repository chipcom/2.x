...
Function forma14_med_oms()
  ...
  // //////////////////////////////////////////////////////////////////
  arr_m := { 2025, 1, 6, 'за январь - июнь 2025 года', 0d20250101, 0d20250630 }  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  // //////////////////////////////////////////////////////////////////
  ...
  //
  // //////////////////////////////////////////////////////////////////
  mdate_rak := arr_m[ 6 ] + 13 // по какую дату РАК сумма к оплате 13.07.25    Основание - письмо  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  // //////////////////////////////////////////////////////////////////
  ...
  Do While !Eof()
    ...
    If schet_->IS_DOPLATA == 0 .and. !Empty( Val( schet_->smo ) ) .and. schet_->NREGISTR == 0 // только зарегистрированные
      ...
      //
      // 2025 год
      k := 7 // дата регистрации по 07.07.25 // Основание - письмо!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      //
