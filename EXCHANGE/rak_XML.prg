...
Function reestr_rak_tmpfile( oXmlDoc, aerr, mname_xml )
  ...
  Local j, j1, j2, j3, oXmlNode, oNode1, oNode2, oNode3
  local _ar
  ...
  For j := 1 To Len( oXmlDoc:aItems[ 1 ]:aItems )
    @ MaxRow(), 1 Say PadR( lstr( j ), 6 ) Color 'GR+/R, , , , B/W'
