...
Function reconstruct_db( is_local_version )
  ...
  Local kartotek := { ;
    ...
    { 'PC3',        'C',  10, 0 }, ; // Социальная категория: '000' - нет, '035' - участник специальной военной операции (СВО), уволенный в запас (отставку), '065' - член семьи участника СВО, '083' - инвалид I группы
