...
// 14.01.26 реконстукция баз данных
...
//  { 'SIZ_INJ',    'N',  15, 2 }, ;  // Стоимость израсходованного лек. препарата
  ...
  Local mo_rees := { ; // Реестр сведений об оказанной медицинской помощи, направляемый в ТФОМС 'mo_rees'
    ...
    { 'RES_TFOMS',  'N', 1, 0 }  ; // результат проверки реестра сета в ТФОМС ( 1-счет принят, 2-ошибка всего реестра, 3-ошибка в записях реестра)
  }
