...
***** 06.12.21 проверка и переиндексирование справочников ТФОМС
Function checkFilesTFOMS()
  ...
  aadd(arrRefFFOMS, {'_mo_v010', .f., 'V010 - Классификатор способов оплаты медицинской помощи' } )
  aadd(arrRefFFOMS, {'_mo_v015', .f., 'V015 - Классификатор медицинских специальностей' } )
