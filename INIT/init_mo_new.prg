...
#define CURRENT_YEAR 2021   // текущий год работы
...
***** 05.11.21 проверка и переиндексирование справочников ТФОМС
Function checkFilesTFOMS()
  ...
  // справочник соответствия услуг ВМП услугам ТФОМС на CURRENT_YEAR год
  sbase := "_mo1vmp_usl"
  if ! hb_FileExists(exe_dir + sbase + sdbf)
    fl := notExistsFileNSI( exe_dir + sbase + sdbf )
  endif
