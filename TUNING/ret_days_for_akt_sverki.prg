...
// 19.04.26 график регистрации счетов, включаемых в акт сверки на 2025 год
//             
// !!! ВНИМАНИЕ
...
//   STATIC sad24 := { 13, 14, 11, 15, 14, 11, 13, 12, 11, 13, 12, 16 }
   ...
   if isnil( hArr )
      ...
      hb_hSet( hArr, 2026, { 31, 31, {20, 15,  7,  8,  5,  7,  7,  7,  7,  9,  7, 15 }, ;  // письмо 17.03.26 03-30/57
                                    { 20, 18, 10, 14, 10, 10, 12, 10, 12, 12, 10, 20 } } )                             
   endif
