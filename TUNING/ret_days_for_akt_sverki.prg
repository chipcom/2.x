...
// **** 16.01.23 график регистрации счетов, включаемых в акт сверки на 2023 год
...
FUNCTION ret_days_for_akt_sverki( arr_m, /*@*/b1,/*@*/b2,/*@*/a1,/*@*/a2)
   ...
   STATIC sd23 :=  { 14,  7,  7, 10,  7,  7,  7,  7,  6,  8,  7, 12 }
   STATIC sad23 := { 14, 14, 13, 16, 14, 13, 11, 13, 12, 14, 13, 18 }
