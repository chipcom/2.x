...
// 25.01.25 график регистрации счетов, включаемых в акт сверки на 2025 год
//             
// !!! ВНИМАНИЕ
...
//   STATIC sad24 := { 13, 14, 11, 15, 14, 11, 13, 12, 11, 13, 12, 16 }
   ...
   if isnil( hArr )
      ...
      hb_hSet( hArr, 2025, { 31, 31, {7,  7,  7,  13,  6,  7,  7,  5,  7, 10,  5, 15 }, ;  // письмо
                                    { 13, 13, 13, 19, 12, 13, 13, 11, 13, 16, 11, 21 } } )                                    
   endif
