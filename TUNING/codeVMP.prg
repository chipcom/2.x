...
function baseRate(dt, type_USL_OK)
  ...
  if isnil(aRate)
    ...
    aRate := { ;
      {USL_OK_HOSPITAL, 29995.8, 0d20231001, 0d20231231}, ; // КС 2023 с 01.10.23
      {USL_OK_HOSPITAL, 25986.7, 0d20230101, 0d20230930}, ; // КС 2023 до 01.10.23
      {USL_OK_DAY_HOSPITAL, 15029.1, 0d20230101, 0d20231231}, ; // ДС 2023
      {USL_OK_HOSPITAL, 24322.6, 0d20220101, 0d20221231}, ; // КС 2022
      {USL_OK_DAY_HOSPITAL, 13915.7, 0d20220101, 0d20221231} ; // ДС 2022
    }
  endif
