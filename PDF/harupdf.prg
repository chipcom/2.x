...
FUNCTION DesignHaruPDF( cFileToSave )
  ...
  LOCAL i,  samp_text, font, tw, def_font
  LOCAL page_title := "hbhpdf demo"
//   LOCAL page_title := "hbhpdf демострация"
  LOCAL font_list  := { ;
     "Courier"               , ;
     "Courier-Bold"          , ;
     "Courier-Oblique"       , ;
   ...
   */
   ...
   // HPDF_Page_Rectangle( page, 10, height - 20, 10, 10 )
   // HPDF_Page_Stroke( page )

   // HPDF_Page_Rectangle( page, width - 20, height - 20, 10, 10 )
   // HPDF_Page_Stroke( page )

   // HPDF_Page_Rectangle( page, 10, 10, 10, 10 )
   // HPDF_Page_Stroke( page )

   // HPDF_Page_Rectangle( page, width - 20, 10, 10, 10 )
   // HPDF_Page_Stroke( page )
