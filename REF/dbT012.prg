** 05.10.22 вернуть Классификатор ошибок ИСОМП T012.xml
function getT012()
  ...
  if len(_arr) == 0
    ...
    aadd(_arr, {'Дата постановки (DATE_B) на диспансерный учет некорректна', 118, 'ТК1', stod('20170101'), stod('22220101')})
    ...
    aadd(_arr, {'Превышена установленная на месяц  численность (Общая по диспансеризации(O))', 122, 'ТК1', stod('20170101'), stod('22220101')})
