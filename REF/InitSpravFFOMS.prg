***** 06.03.21 инициализация справочников ФФОМС
Function InitSpravFFOMS()
  ...
  {59,447,"УД 1 этап","УД 1",""},;  // НОВЫЙ 21.10.2021
  ...
  {72,448,"УД 2 этап","УД 2","",""},; // НОВЫЙ 21.10.2021
  ...
  {78,449,"КТ (межбюджетный трансфер)","KT","",""},; // НОВЫЙ 21.10.2021
