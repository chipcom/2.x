...
//
// 12.03.24 проверка услувия для применения КСЛП=30 для 2024 года
function conditionKSLP_1_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
// 12.03.24 проверка услувия для применения КСЛП=31 для 2024 года
function conditionKSLP_2_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_3_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_19_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
// 12.03.24 проверка условия для применения КСЛП=20 для 2024 года
function conditionKSLP_20_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
  // 3.1.4
...
function conditionKSLP_21_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_22_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_23_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_24_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_25_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_26_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_27_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
// 12.03.24 проверка условия для применения КСЛП=28 для 2024 года
function conditionKSLP_28_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_29_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_33_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_34_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_35_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_36_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
...
function conditionKSLP_37_24( aKSLP, DOB, n_date, profil, lshifr, lpar_org, arr_diag, duration, usl_ok, lad_cr )
  // КСЛП=34 - проведение сопроводительной лекарственной терапии при злокачественных
  // новообразованиях у взрослых в в условиях дневного стационара в соответствии с клиническими
  // рекомендациями (уровень 3);   
  // 3.1.4. Проведение сопроводительной лекарственной терапии при злокачественных
