...
Function f_valid2ad_cr(k_date)
  ...
  Static mm_rd_2023 := { ;
    ...
    {'rbbp4 - продолжительная медицинская реабилитация (30 дней), 4-балла по ШРМ, назначение ботулинического токсина', 'rbbp4'}, ;
    {'rbbp5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по ШРМ, назначение ботулинического токсина', 'rbbp5'}, ;
    {'rbbprob4 - продолжительная медицинская реабилитация (30 дней), 4-балла по ШРМ с применением роботизированных систем и назначение ботулинического токсина', 'rbbprob4'}, ;
    {'rbbprob5 - продолжительная медицинская реабилитация (30 дней), 5-баллов по ШРМ с применением роботизированных систем и назначение ботулинического токсина', 'rbbprob5'}, ;
    ...
    {'rbp4 - продолжительная медицинская реабилитация (30 дней), 4-балла по ШРМ', 'rbp4'}, ;
    {'rbp5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по ШРМ', 'rbp5'}, ;
    {'rbprob4 - продолжительная медицинская реабилитация (30 дней), 4-балла по ШРМ с применением роботизированных систем', 'rbprob4'}, ;
    {'rbprob5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по ШРМ с применением роботизированных систем', 'rbprob5'}, ;
    {'rbps5 - продолжительная  медицинская реабилитация (сестринский уход) (30 дней), 5 баллов по ШРМ', 'rbps5'}, ;
