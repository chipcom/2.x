...
Function f_valid2ad_cr(k_date)
  ...
  Static mm_rd_2023 := { ;
    {'rb4d12 - 4 балла по шкале реабилитационной маршрутизации (ШРМ), не менее 12 дней', 'rb4d12'}, ;
    {'rb4d14 - 4 балла по шкале реабилитационной маршрутизации (ШРМ), не менее 14 дней', 'rb4d14'}, ;
    {'rb5d18 - 5 баллов по шкале реабилитационной маршрутизации (ШРМ), не менее 18 дней', 'rb5d18'}, ;
    {'rb5d20 - 5 баллов по шкале реабилитационной маршрутизации (ШРМ), не менее 20 дней', 'rb5d20'}, ;
    {'rbb2 - 2 балла по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина', 'rbb2'}, ;
    {'rbb3 - 3 балла по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина', 'rbb3'}, ;
    {'rbb4d14 - 4 балла по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина, не менее 14 дней', 'rbb4d14'}, ;
    {'rbb5d20 - 5 балла по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина, не менее 20 дней', 'rbb5d20'}, ;
    {'rbbp4 - продолжительная медицинская реабилитация (30 дней), 4-балла по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина', 'rbbp4'}, ;
    {'rbbp5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по шкале реабилитационной маршрутизации (ШРМ), назначение ботулинического токсина', 'rbbp5'}, ;
    {'rbbprob4 - продолжительная медицинская реабилитация (30 дней), 4-балла по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем и назначение ботулинического токсина', 'rbbprob4'}, ;
    {'rbbprob5 - продолжительная медицинская реабилитация (30 дней), 5-баллов по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем и назначение ботулинического токсина', 'rbbprob5'}, ;
    {'rbbrob4d14 - 4 балла по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем и назначение ботулинического токсина, не менее 14 дней', 'rbbrob4d14'}, ;
    {'rbbrob5d20 - 5 баллов по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем и назначение ботулинического токсина, не менее 20 дней', 'rbbrob5d20'}, ;
    {'rbp4 - продолжительная медицинская реабилитация (30 дней), 4-балла по шкале реабилитационной маршрутизации (ШРМ)', 'rbp4'}, ;
    {'rbp5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по шкале реабилитационной маршрутизации (ШРМ)', 'rbp5'}, ;
    {'rbprob4 - продолжительная медицинская реабилитация (30 дней), 4-балла по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем', 'rbprob4'}, ;
    {'rbprob5 - продолжительная  медицинская реабилитация  (30 дней) , 5 баллов по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем', 'rbprob5'}, ;
    {'rbps5 - продолжительная  медицинская реабилитация (сестринский уход) (30 дней), 5 баллов по шкале реабилитационной маршрутизации (ШРМ)', 'rbps5'}, ;
    {'rbrob4d12 - 4 балла по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем, не менее 12 дней', 'rbrob4d12'}, ;
    {'rbrob4d14 - 4 балла по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем, не менее 14 дней', 'rbrob4d14'}, ;
    {'rbrob5d18 - 5 баллов по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем, не менее 18 дней', 'rbrob5d18'}, ;
    {'rbrob5d20 - 5 баллов по шкале реабилитационной маршрутизации (ШРМ) с применением роботизированных систем, не менее 20 дней', 'rbrob5d20'} ;
  }
  Static mm_rd_deti := { ;
  ...
  if m1usl_ok < 3 .and. m1vmp == 0
    if m1profil == 158 // реабилитация
      input_ad_cr := .t.
      // if count_years(mdate_r, k_date) < 18 .and. k_date >= 0d20230101
      //   mm_ad_cr := aclone(mm_rd_deti)
      // else
      ...
      if count_years(mdate_r, k_date) < 18 .and. k_date >= 0d20230101
        aadd(mm_ad_cr, mm_rd_deti[1])
        aadd(mm_ad_cr, mm_rd_deti[2])
        aadd(mm_ad_cr, mm_rd_deti[3])
        aadd(mm_ad_cr, mm_rd_deti[4])
        aadd(mm_ad_cr, mm_rd_deti[5])
        aadd(mm_ad_cr, mm_rd_deti[6])
      endif
