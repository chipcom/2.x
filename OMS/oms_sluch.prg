...
// 20.09.25 селектор для добавления или редактирования случаев (листов учета)
Function oms_sluch( Loc_kod, kod_kartotek )
  ...
  Elseif Len( otdelenie ) > 3
    ...
    Elseif otdelenie[ 4 ] == TIP_LU_DRZ // диспнсеризация репродуктивного здоровья взрослого населения
