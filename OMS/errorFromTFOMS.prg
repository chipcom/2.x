...
// 01.09.25 Редактирование случая с выбором по конкретной ошибке из ТФОМС
Function oms_edit_error_TFOMS()
...
//          find ( Str( tmp_h->kod, 7 ) )
          hu->( dbSeek( Str( tmp_h->kod, 7 ) ) )
          Do While tmp_h->kod == hu->kod .and. !hu->( Eof() )
//            Select hu2
//            Goto tmp_h->kod
            hu2->( dbGoto(tmp_h->kod) )
//            Select  frd2
//            Append Blank
            frd2->( dbAppend() )
