...
Function e_statist( k )
  ...
  Case k == 11
    ...
    mas_pmt := { ;
      ...
      '~Сводная информация' }
    mas_msg := { ;
      'Статистика по выставленным счетам', ;
  ...
  Case k == 121
    mas_pmt := { ;
      ...
      '~Узкие специалисты' }
    mas_msg := { ;
      'Статистическая информация по всем счетам за период времени', ;
  ...
  Case k == 123
    ...
    mas_msg := { ;
      'Суммы снятий с расшифровкой по СМО, дефектам и видам экспертизы', ;
  ...
  Case k == 125
    mas_pmt := { ;
      ...
      '~Оборотная ведомость' }
    mas_msg := { ;
      'Распечатка акта сверки по конкретной СМО', ;
  ...
  Case k == 14
    mas_pmt := { ;
      'Статистические формы (по дате ~окончания лечения)', ;
    ...
    mas_msg := { ;
      'Статистика по диагнозам и статистические формы (по дате окончания лечения)', ;
  ...
  Case k == 16
    ...
    mas_msg := { ;
      'Создание отчётов по иногородним и иностранцам для КЗВО', ;
  ...
  Case k == 172
    mas_pmt := { ;
      'Снятия, оплата, ~долги по счетам', ;
      'Составление ~оборотной ведомости', ;
      'Ввод входящего ~сальдо' }
    mas_msg := { ;
      'Распечатка информации по счетам, сумме снятий по ним, сумме оплате и долге', ;
  ...
  Case k == 31
    mas_pmt := { ;
      'По отделениям, где ~выписан счет', ;
  ...
  Case k == 44
    mas_pmt := { ;
      'Правила ~Комитета здравоохранения', ;
      'Правила ~лечебного учреждения' }
    mas_msg := { ;
      'Просмотр правил статистики Комитета здравоохранения', ;
  ...
  Case k == 51
    ...
    mas_msg := { ;
      'Статистика по диагнозам: общая форма', ;
...
// 02.05.26 восстановление объёмов
Function vosst_ob_em_rak()
  ...
  Do While .t.
    ...
    @ r + 7, 2 Say 'Отчётный год 2026, отчётный квартал' Get mkvartal Pict '9' Range 0, 4
    myread()
    If LastKey() == K_ESC
      Exit
    Endif
    ...
    Elseif pdate[ 1 ] < 2026
      func_error( 4, 'Данный режим написан для 2026 года' )
    Elseif Empty( m1smo )
...
Function ob1_statist( k, k1 )
  ...
  Case k == 0
    ...
    mas_pmt := { ;
      ...
      '~Заработная плата' }
    mas_msg := { ;
      'Статистика по объёму работ с подсчетом стоимости лечения', ;
  ...
  Case k == 1
    ...
    mas_pmt := { ;
      ...
      '~Услуги' }
    mas_msg := { ;
      'Статистика по работе персонала и оказанным услугам в отделениях', ;
  ...
  Case k == 11  // отделения
    ...
    mas_msg := { ;
      'Количество услуг и сумма лечения по отделениям', ;
  ...
  Case k == 12  // службы
    ...
    mas_msg := { ;
      'Количество услуг и сумма лечения по службам (с разбивкой по отделениям)', ;
  ...
  Case k == 13  // персонал
    ...
    mas_msg := { ;
      'Статистика по работе конкретного работающего (плюс оказанные услуги)', ;
...
Function obf_statist( k, k1 )
  ...
  Case k == 1
    ...
    mas_pmt := { ;
      ...
      '~Номенклатура' }
    mas_msg := { ;
      'Статистика по работе персонала и оказанным номенклатурным услугам в отделениях', ;
      'Статистика по работе персонала (независимо от отделения)', ;
  ...
  Case k == 11  // отделения
    mas_pmt := { ;
      ...
      'Отделение + 1 человек + бо~льные' }
    mas_msg := { ;
      'Количество услуг по отделениям', ;
      'Статистика по работе персонала в конкретном отделении', ;
      'Статистика по услугам, оказанным в конкретном отделении', ;
      'Статистика по услугам, оказанным в отделениях (плюс промежуточные итоги)', ;
      'Статистика по работе персонала (плюс оказанные услуги) в конкретном отделении', ;
...
Function prn_blank( k )
  ...
  Case k == 1
    ...
    mas_msg := { ;
      'Распечатка бланков и справочников для онкологических листов учёта', ;
  ...
  Case k == 11
    mas_pmt := { ;
      '~Контрольный лист учёта ЗНО', ;
      '~Правила заполнения контрольного листа учёта ЗНО' }
    mas_msg := { ;
      'Распечатка контрольного листа учёта мед.помощи, оказанной пациентам, страдающим ЗНО', ;
  ...
  Case k == 12
    mas_pmt := { ;
      'Приложение к ~карте вызова СМП', ;
      '~Правила заполнения приложения' }
    mas_msg := { ;
      'Распечатка приложения к карте вызова скорой помощи', ;
  ...
  Case k == 13
    ...
    mas_msg := { ;
      'Распечатка бланка листа учёта для диспансеризации детей-сирот', ;
  ...
  Case k == 14
    ...
    mas_msg := { ;
      'Распечатка бланка листа учёта для диспансеризации взрослого населения I этап', ;
  ...
  Case k == 15
    mas_pmt := { ;
      'Лист учёта ~профилактики несовершеннолетних', ;
    ...
    mas_msg := { ;
      'Распечатка бланка листа учёта для профилактики несовершеннолетних', ;
  ...
  Case k == 16
    mas_pmt := { ;
      'Углубленная ~диспансеризация I этап', ;
      'Углубленная диспансеризация II ~этап' }
    mas_msg := { ;
      'Распечатка бланка листа учёта для углубленной диспансеризации I этап', ;
  ...
  Case k == 17
    ...
    mas_msg := { ;
      'Распечатка бланка реабилитации сердечно-сосудистых состояний', ;
  ...
  Case k == 18
    mas_pmt := { ;
      'Диспансеризация репродуктивного здоровья женщины I этап', ;
      'Диспансеризация репродуктивного здоровья мужчины I этап', ;
      'Диспансеризация репродуктивного здоровья II этап' }
    mas_msg := { ;
      'Распечатка бланка листа учёта для диспансеризации рерпродуктивного здоровья женщин I этап', ;
