...
function np_arr_not_zs( mdata ) // замена на услуги с ценой (нет законченного случая)
  ...
  if mdata >= 0d20250901 
    ...
    arr_not_zs := { ;  
      ...
      { '2.94.2', '2.3.9' }, ;   // невролог
      { '2.94.3', '2.3.10' }, ;   // детский хирург
      { '2.94.4', '2.3.11' }, ;   // офтальмолог
      { '2.94.5', '2.3.12' }, ;   // детский стоматолог
      { '2.94.6', '2.3.13' }, ;   // травматолог-ортопед
      { '2.94.7', '2.3.14' }, ;   // отоларинголог
      { '2.94.8', '2.3.15' }, ;    // акушер-гинеколог
      { '2.94.9', '2.3.16' }, ;    // детский уролог-андролог
      { '2.94.10', '2.3.17' }, ;   // детский эндокринолог
      { '2.94.12', '2.3.9' }, ;   // невролог
      { '2.94.13', '2.3.10' }, ;   // детский хирург
      { '2.94.14', '2.3.11' }, ;   // офтальмолог
      { '2.94.15', '2.3.12' }, ;   // детский стоматолог
      { '2.94.16', '2.3.13' }, ;   // травматолог-ортопед
      { '2.94.17', '2.3.14' }, ;   // отоларинголог
      { '2.94.18', '2.3.15' }, ;   // акушер-гинеколог
      { '2.94.19', '2.3.16' }, ;   //детский уролог-андролог
      { '2.94.20', '2.3.17' } ;  // детский эндокринолог
    }
/*    arr_not_zs := { ;  
