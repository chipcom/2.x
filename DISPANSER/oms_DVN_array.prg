...
function dvn_arr_usl( dateSl, mobil )
  ...
  If dateSl >= 0d20260101
    arr_dvn_usl := { ; // Услуги на экран для ввода
      ...
      { ;
        'Исследование крови на общий холестерин', iif( mobil == 0, '4.12.886', '4.12.962' ), { 1, 3 }, 0, 1, ;
        1, 1, 1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
        'Исследование уровня глюкозы в крови', iif( mobil == 0, '4.12.869', '4.12.963' ), { 1, 3 }, 0, 1, ;
        1, 1, 1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
      ...
      { ;
        'Исследование кала на скрытую кровь', iif( mobil == 0, '4.8.804', '4.8.805' ), 1, 0, 1, ;
      ...
      { ;
        'Исследование крови на Anti-HCV-total', iif( mobil == 0, '4.15.739', '4.15.748' ), 1, 0, 1, ;
        { 45, 55, 65, 75, 85, 95 }, ;
        { 45, 55, 65, 75, 85, 95 }, ;
        1, 0, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
