...
// 17.02.26
function dvn_arr_umolch( dateSl )
...
function dvn_arr_usl( dateSl, mobil )
  ...
  If dateSl >= 0d20260101
    arr_dvn_usl := { ; // Услуги на экран для ввода
      { ;
        'Измерение внутриглазного давления', iif( mobil == 0, '3.4.709', '' ), 1, 0, 1, ;
        Eval( blk, 40, 99 ), ;
        Eval( blk, 40, 99 ), ;
        1, 1, 65, { 1112 };
      }, ;
      { ;
        'Исследование крови на общий холестерин', iif( mobil == 0, '4.12.886', '' ), { 1, 3 }, 0, 1, ;
        1, 1, 1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
        'Исследование уровня глюкозы в крови', iif( mobil == 0, '4.12.869', '' ), { 1, 3 }, 0, 1, ;
        1, 1, 1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
      ...
      { ;
        'Клинический анализ крови (3 показателя)', iif( mobil == 0, '4.11.737', '' ), 1, 0, 1, ;
        Eval( blk, 40, 99 ), ;
        Eval( blk, 40, 99 ), ;
        1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
        'Исследование кала на скрытую кровь', iif( mobil == 0, '4.8.804', '' ), 1, 0, 1, ;
        { 40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75 }, ;
        { 40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75 }, ;
        1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
        'Кровь на простат-специфический антиген', iif( mobil == 0, '4.14.766', '' ), 1, 0, 1, ;
        { 45, 50, 55, 60, 64 }, ;
        0, ;
        1, 0, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };
      }, ;
      { ;
        'Осмотр акушеркой или акушером-гинекологом', iif( mobil == 0, '2.3.1', '' ), { 1, 3 }, 0, 1, ; // женщины not found
        0, 1, 0, 1, { 3, 42, 136 }, { 2003, 2002, 1101 }, ;
        { { '2.3.1', 136 }, { '2.3.3', 3 }, { '2.3.3', 42 } }, 1, 1;
      }, ;
      { ;
        'Взятие мазка (соскоба) с пов-ти шейки матки', iif( mobil == 0, '4.1.712', '' ), 1, 0, 1, ; // женщины
        0, ;
        { 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51, 54, 57, 60, 63 }, ;
        1, 1, { 3, 42, 136 }, { 2003, 2002, 1101 };
      }, ;
      { ;
        'Иссл-е взятого цитологического материала', iif( mobil == 0, '4.20.701', '' ), 1, 0, 1, ; // если невозможна 4.1.12
        0, ;
        { 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51, 54, 57, 60, 63 }, ;     // то очистить
        1, 1, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 };               // эту услугу
      }, ;
      { ;
        'Маммография обеих молочных желез', iif( mobil == 0, '7.57.705', '' ), 1, 0, 1, ; // женщины
        0, ;
        { 40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 72, 74 }, ;
        0, 1, 78, { 1118, 1802, 2020 };
      }, ;
      { ;
        'Флюорография лёгких профилактическая', iif( mobil == 0, '7.61.707', '' ), { 1, 3 }, 0, 1, ;
        Eval( blk, 18, 99, 2 ), ;
        Eval( blk, 18, 99, 2 ), ;
        Eval( blk, 18, 99, 2 ), ;
        Eval( blk, 18, 99, 2 ), ;
      ...
      { ;
        'Электрокардиография (в покое)', iif( mobil == 0, '13.1.705', '' ), { 1, 3 }, 0, 1, ;
        Eval( blk, 35, 99 ), ;
        Eval( blk, 35, 99 ), ;
        Eval( blk, 35, 99 ), ;
        Eval( blk, 35, 99 ), ;
      ...
      { ;
        'Фиброэзофагогастродуоденоскопия', iif( mobil == 0, '10.3.715', '' ), 1, 0, 1, ;
        { 45 }, ;
        { 45 }, ;
