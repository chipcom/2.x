...
Function inf_disp_nabl()
 ...
 //               my_debug(,substr(alltrim(dn->kod_diag),1,3))
    ...
    Else
      ...
      add_string("                 │   всего   │в 12.2024│ с ошибкой │   ответ  │")
      add_string("─────────────────┴───────────┴─────────┴───────────┴──────────┴") 
...
Function f_create_d01()
  ...
  Index On Upper( kart->fio ) + DToS( kart->date_r ) + Str( kod_k, 7 ) to ( cur_dir + "tmp_dn" ) For kart->kod > 0 .and. dn->next_data > 0d20250101 // временно
