...
// 08.04.24 подмена полей в рабочем массиве arr_osm1 объявленным PRIVATE
...
// 08.04.24 скорректировать массивы по углубленной диспансеризации COVID
Function ret_array_drz()
  ...
  dvn_drz_arr_usl := { ; // Услуги на экран для ввода
    ...
    { ;
      'Женщины I этап 18-29 лет', ; // наименование меню
      '70.9.1', ; // шифр услуги
      1, ;  // этап или список допустимых этапов, пример: {1, 2}
      0, ;  // диагностическая услуга (0-нет, 1-да)
      0, ;  // возможен отказ пациента (0 - да, 1 - нет)
    ...
    { ;
      'Женщины I этап 30-49 лет', ; // наименование меню
      '70.9.2', ; // шифр услуги
      1, ;  // этап или список допустимых этапов, пример: {1, 2}
      0, ;  // диагностическая услуга (0-нет, 1-да)
      0, ;  // возможен отказ пациента (0 - да, 1 - нет)
