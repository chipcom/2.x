...
// 07.11.25
function DDS_arr_etap( mdata, mobil, tip_lu )
  ...
  //      { /* услуги */}, ;
  //      { /* исследования */ } } )
  local aUsl, aUsl3, aUsl5
  local aIssl, aIssl1, aIssl7, aIssl15

  default mobil to 0
  default tip_lu to TIP_LU_DDS
  if mdata >= 0d20250901  // после 01 сентября 25 года
    AAdd( arr_DDS_etap, { 1, { 0, 0 }, { 0, 1 }, ;
      {}, ;
      { '4.26.100', '3.5.704' } } )
    AAdd( arr_DDS_etap, { 2, { 0, 1 }, { 0, 2 }, ;
      iif( tip_lu == TIP_LU_DDS, ;
        iif( mobil == 0, { '70.5.102', '70.5.103' }, ;
          { '70.5.112', '70.5.113' } ), ;
    ...
    if mdata >= 0d20260101
      AAdd( arr_DDS_etap, { 13, { 1, 0 }, { 1, 1 }, ;
        iif( tip_lu == TIP_LU_DDS, ;
          iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.109' }, ;
             { '70.5.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116', '70.5.119' } ), ;
        ...
        { '4.2.753', '4.11.736', '8.2.701', '8.1.706', '8.1.703', '13.1.701', '4.29.3', '13.2.100', '13.2.101' } } )
    else
      AAdd( arr_DDS_etap, { 13, { 1, 0 }, { 1, 1 }, ;
        iif( tip_lu == TIP_LU_DDS, ;
          iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.109' }, ;
    ...
    AAdd( arr_DDS_etap, { 16, { 1, 11 }, { 2, 1 }, ;
      iif( tip_lu == TIP_LU_DDS, ;
        iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106' }, ;
           { '70.5.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116' } ), ;
    ...
    AAdd( arr_DDS_etap, { 17, { 2, 11 }, { 4, 0 }, ;
      iif( tip_lu == TIP_LU_DDS, ;
        iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.109', '2.4.1' }, ;
           { '70.5.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116', '70.5.119', '2.4.1' } ), ;
    ...
    AAdd( arr_DDS_etap, { 18, { 4, 0 }, { 5, 0 }, ;
      iif( tip_lu == TIP_LU_DDS, ;
        iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '2.4.1' }, ;
           { '70.6.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116', '2.4.1' } ), ;
    ...
    AAdd( arr_DDS_etap, { 19, { 5, 0 }, { 6, 0 }, ;
      iif( tip_lu == TIP_LU_DDS, ;
        iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.109', '2.4.1' }, ;
           { '70.6.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116', '70.5.119', '2.4.1' } ), ;
        iif( mobil == 0, { '70.6.101', '70.6.102', '70.6.103', '70.6.104', '70.6.105', '70.6.106', '70.6.109', '2.4.1' }, ;
           { '70.6.111', '70.6.112', '70.6.113', '70.6.114', '70.6.115', '70.6.116', '70.6.119', '2.4.1' } ) ;
      ), ;
      { '4.11.736', '4.2.753', '8.2.701', '13.1.701', '4.29.3' } } )
    if mdata >= 0d20260101
      AAdd( arr_DDS_etap, { 20, { 6, 0 }, { 7, 0 }, ;
        iif( tip_lu == TIP_LU_DDS, ;
          iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.107', '70.5.108', '70.5.109', '2.4.1' }, ;
             { '70.5.111', '70.5.112', '70.5.113', '70.5.114', '70.5.115', '70.5.116', '70.5.117', '70.5.118', '70.5.119', '2.4.1' } ), ;
        ...
        { '4.11.736', '4.2.753', '8.2.701', '8.1.706', '8.1.707', '8.1.703', '8.2.706', '8.2.707', '13.1.701', '4.29.2', '4.29.3', '13.2.100' } } )
    else
      AAdd( arr_DDS_etap, { 20, { 6, 0 }, { 7, 0 }, ;
        iif( tip_lu == TIP_LU_DDS, ;
          iif( mobil == 0, { '70.5.101', '70.5.102', '70.5.103', '70.5.104', '70.5.105', '70.5.106', '70.5.107', '70.5.108', '70.5.109', '2.4.1' }, ;
...
/*
    AAdd( dds_iss, { 'Клинический анализ мочи', '', { '4.2.153' } } )
    AAdd( dds_iss, { 'Клинический анализ крови', '', { '4.11.136' } } )
    AAdd( dds_iss, { 'Исследование уровня глюкозы в крови', '', { '4.12.169' } } )
    AAdd( dds_iss, { 'Электрокардиография', '', { '13.1.1' } } )
    AAdd( dds_iss, { 'Флюорография легких (с 15 лет)', '', { '7.61.3' } } )
    AAdd( dds_iss, { 'УЗИ головного мозга (нейросонография) (до 1 года)', '' { 110101, 111004, 111802, 111903, 112211, 112610, 113416, 113508, 180203 }, { '8.1.1' } } )
    AAdd( dds_iss, { 'УЗИ щитовидной железы (с 7 лет)', '', { '8.1.2' } } )
    AAdd( dds_iss, { 'УЗИ сердца', '', { '8.1.3' } } )
    AAdd( dds_iss, { 'УЗИ тазобедренных суставов (до 1 года)', '', { '8.1.4' } } )
    AAdd( dds_iss, { 'УЗИ органов брюшной полости комплексное профилактическое', '', { '8.2.1' } } )
    AAdd( dds_iss, { 'УЗИ органов репродуктивной системы', '', { '8.2.2', '8.2.3' } } )
*/

    aUsl := { '2.83.20', '2.83.21', '2.83.18', '2.83.22', '2.83.16', '2.83.17', '2.83.19', '2.4.1' }
    aUsl3 := AClone( aUsl )
    AAdd( aUsl3, '2.83.23' )  // добавим стоматолога
    aUsl5 := AClone( aUsl3 )
    AAdd( aUsl5, '2.83.24' )  // добавим эндокринолога
    aIssl := { '4.11.136', '4.2.153', '4.12.169', '13.1.1', '8.2.1', '8.1.3' }
    aIssl1 := AClone( aIssl )
    AAdd( aIssl1, '8.1.4' ) // УЗИ тазобедренных суставов (до 1 года)
    AAdd( aIssl1, '8.1.1' ) // УЗИ головного мозга (нейросонография) (до 1 года)
    aIssl7 := AClone( aIssl )
    AAdd( aIssl7, '8.1.2' ) // УЗИ щитовидной железы (с 7 лет)
    AAdd( aIssl7, '8.2.2' ) // УЗИ органов репродуктивной системы с 7 лет
    AAdd( aIssl7, '8.2.3' ) // УЗИ органов репродуктивной системы с 7 лет
    aIssl15 := AClone( aIssl7 )
    AAdd( aIssl15, '7.61.3' ) // Флюорография легких (с 15 лет)

    AAdd( arr_DDS_etap, { 1, { 0, 0 }, { 1, 0 }, ;
      aUsl, ;
      aIssl1 } )
    AAdd( arr_DDS_etap, { 2, { 1, 0 }, { 3, 0 }, ;
      aUsl, ;
      aIssl } )
    AAdd( arr_DDS_etap, { 3, { 3, 1 }, { 5, 0 }, ;
      aUsl3, ;
      aIssl } )
    AAdd( arr_DDS_etap, { 4, { 5, 1 }, { 7, 0 }, ;
      aUsl5, ;
      aIssl } )
    AAdd( arr_DDS_etap, { 5, { 7, 1 }, { 15, 0 }, ;
      aUsl5, ;
      aIssl7 } )
    AAdd( arr_DDS_etap, { 6, { 15, 1 }, { 18, 0 }, ;
      aUsl5, ;
      aIssl15 } )
...
function DDS_arr_issled( mdata )
  ...
  if mdata >= 0d20250901
    ...
    if mdata >= 0d20260101
      AAdd( arr_DDS_issled, { '13.2.100',   , 'исследование вызванное отоакустической эмиссией', 0, 162, { 1111, 111101 } } )
      AAdd( arr_DDS_issled, { '13.2.101',   , 'офтальмоскопия в услових мидриаза', 0, 65, { 1112 } } )
    else
      AAdd( arr_DDS_issled, { '13.2.1',   , 'исследование вызванное отоакустической эмиссией', 0, 162, { 1111, 111101 } } )
      AAdd( arr_DDS_issled, { '13.2.2',   , 'офтальмоскопия в услових мидриаза', 0, 65, { 1112 } } )
    endif
...
#define I_ETAP  2
#define II_ETAP 3
function dds_arr_osm1_new( mdata, mobil, tip_lu, type )
  ...
  default type to 0 // где 0 - всё, 1 - исследования, 2 - I этап, 3 - II этап
  dds_osm1 := {}

  if mdata >= 0d20250901
    if tip_lu == TIP_LU_DDSOP
      if eq_any( type, ALL, II_ETAP )
...
//      AAdd( dds_osm1, { 'педиатр', { 68, 57 }, { 1134, 1110 }, { '2.83.14', '2.83.15' } } )
      endif
      if mobil == 0
        if eq_any( type, ALL, I_ETAP )
...
//      AAdd( dds_osm1, { { '2.83.14', '2.83.15' }, ' ', 'педиатр', { 68, 57 }, { 1134, 1110 } } )
    ...
    elseif tip_lu == TIP_LU_DDSOP
      if eq_any( type, ALL, II_ETAP )
        AAdd( dds_osm1, { '2.87.1', 'пульмонолог', ' ', 75, { 113413, 112208, 112501 } } )
        AAdd( dds_osm1, { '2.87.2', 'дерматовенеролог', ' ', 16, { 1104 } } )
        AAdd( dds_osm1, { '2.87.3', 'ревматолог', ' ', 77, { 113414, 112209 } } )
        AAdd( dds_osm1, { '2.87.4', 'аллерголог-иммунолог', ' ', 4, { 113405, 112214 } } )
        AAdd( dds_osm1, { '2.87.5', 'детский кардиолог', ' ', 17, { 113403 } } )
        AAdd( dds_osm1, { '2.87.6', 'гастроэнтеролог', ' ', 11, { 113407, 112201 } } )
        AAdd( dds_osm1, { '2.87.7', 'нефролог', ' ', 56, { 113412, 112207 } } )
        AAdd( dds_osm1, { '2.87.8', 'гематолог', ' ', 12, { 113408, 112202 } } )
        AAdd( dds_osm1, { '2.87.9', 'инфекционист', ' ', 28, { 1106 } } )
        AAdd( dds_osm1, { '2.87.10', 'детский онколог', ' ', 18, { 113401, 112801, 113501 } } )
        AAdd( dds_osm1, { '2.87.11', 'нейрохирург', ' ', 54, { 112602, 113504 } } )
        AAdd( dds_osm1, { '2.87.12', 'колопроктолог', ' ', 30, { 112601, 113503 } } )
        AAdd( dds_osm1, { '2.87.13', 'сердечно-сосудистый хирург', ' ', 81, { 112604, 113505 } } )
//      AAdd( dds_osm1, { 'педиатр', { 68, 57 }, { 1134, 1110 }, { '2.83.14', '2.83.15' } } )
      endif
      if mobil == 0
        if eq_any( type, ALL, I_ETAP )
          AAdd( dds_osm1, { '2.87.21', ' ', 'офтальмолог', 65, { 1112 } } )
          AAdd( dds_osm1, { '2.87.22', ' ', 'оториноларинголог', 162, { 1111, 111101 } } )
          AAdd( dds_osm1, { '2.87.18', ' ', 'детский хирург', 20, { 1135 } } )
          AAdd( dds_osm1, { '2.87.19', ' ', 'травматолог-ортопед', 100, { 1123 } } )
          AAdd( dds_osm1, { '2.87.16', 'Ж', 'акушер-гинеколог (девочки)', 136, { 1101 } } )
          AAdd( dds_osm1, { '2.87.17', 'М', 'детский уролог-андролог (мальчики)', 19, { 112603, 113502 } } )
          AAdd( dds_osm1, { '2.87.23', ' ', 'детский стоматолог', 86, { 1401, 140102 } } )
          AAdd( dds_osm1, { '2.87.24', ' ', 'детский эндокринолог', 21, { 1127, 112702, 113402 } } )
          AAdd( dds_osm1, { '2.87.20', ' ', 'невролог', 53, { 1109 } } )
          AAdd( dds_osm1, { '2.4.1', ' ', 'психиатр', 72, { 1115 } } )
//      AAdd( dds_osm1, { { '2.87.14', '2.87.15' }, ' ', 'педиатр', { 68, 57 }, { 1134, 1110 } } )
        endif
      endif
    endif
  endif
...
function dds_arr_osm1( mdata )
  ...
  if mdata >= 0d20250901
    ...
    AAdd( dds_osm1, { '2.83.20', ' ', 'невролог', 53, { 1109 } } )
    AAdd( dds_osm1, { '2.4.1', ' ', 'психиатр', 72, { 1115 } } )
//    AAdd( dds_osm1, { '2.83.14', ' ', 'педиатр', 68, { 1134, 1110 } } )
/*
...
function DDS_usl_replace( mdata )
  ...
  if mdata >= 0d20250901 
    ...
    arr_zamena := { ;  
      ...
      { '70.5.101', '2.3.9' }, ;   // невролог
      { '70.5.102', '2.3.10' }, ;   // детский хирург
      { '70.5.103', '2.3.11' }, ;   // офтальмолог
      { '70.5.104', '2.3.12' }, ;   // детский стоматолог
      { '70.5.105', '2.3.13' }, ;   // травматолог-ортопед
      { '70.5.106', '2.3.14' }, ;   // отоларинголог
      { '70.5.107', '2.3.15' }, ;    // акушер-гинеколог
      { '70.5.108', '2.3.16' }, ;    // детский уролог-андролог
      { '70.5.109', '2.3.17' }, ;   // детский эндокринолог
      { '70.5.111', '2.3.9' }, ;   // невролог
      { '70.5.112', '2.3.10' }, ;   // детский хирург
      { '70.5.113', '2.3.11' }, ;   // офтальмолог
      { '70.5.114', '2.3.12' }, ;   // детский стоматолог
      { '70.5.115', '2.3.13' }, ;   // травматолог-ортопед
      { '70.5.116', '2.3.14' }, ;   // отоларинголог
      { '70.5.117', '2.3.15' }, ;   // акушер-гинеколог
      { '70.5.118', '2.3.16' }, ;   //детский уролог-андролог
      { '70.5.119', '2.3.17' }, ;  // детский эндокринолог
...
//      { '13.2.2',   '13.2.101' }, ;    // офтальмоскопия в условиях мидриаза
    if mdata >= 0d20260101
      // с тарифом, без тарифа
      AAdd( arr_zamena, { '13.2.100',   '13.2.1' } )  // отоакустическая эмиссия
      AAdd( arr_zamena, { '13.2.101',   '13.2.2' } )  // офтальмоскопия в условиях мидриаза
    else
      // с тарифом, без тарифа
      AAdd( arr_zamena, { '13.2.1',   '13.2.100' } )  // отоакустическая эмиссия
      AAdd( arr_zamena, { '13.2.2',   '13.2.101' } )  // офтальмоскопия в условиях мидриаза
    endif
