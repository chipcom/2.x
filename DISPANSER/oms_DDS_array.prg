...
function DDS_arr_etap( mdata, mobil )
  ...
  if mdata >= 0d20250901  // после 01 сентября 25 года
    ...
    AAdd( arr_DDS_etap, { 29, { 15, 0 }, { 16, 0 }, ;
      iif( mobil == 0, { '70.6.101', '70.6.102', '70.6.103', '70.6.104', '70.6.105', '70.6.106', '70.6.107', '70.6.108', '70.6.109', '2.4.1' }, ;
         { '70.6.111', '70.6.112', '70.6.113', '70.6.114', '70.6.115', '70.6.116', '70.6.117', '70.6.118', '70.6.119', '2.4.1' } ), ;
      { '4.11.736', '4.2.753', '8.2.701', '8.1.706', '13.1.701', '4.29.4' } } )
    ...
    AAdd( arr_DDS_etap, { 31, { 17, 0 }, { 18, 0 }, ;
      iif( mobil == 0, { '70.6.101', '70.6.102', '70.6.103', '70.6.104', '70.6.105', '70.6.106', '70.6.107', '70.6.108', '70.6.109', '2.4.1' }, ;
         { '70.6.111', '70.6.112', '70.6.113', '70.6.114', '70.6.115', '70.6.116', '70.6.117', '70.6.118', '70.6.119', '2.4.1' } ), ;
      { '4.11.736', '4.2.753', '8.2.701', '8.1.706', '8.1.707', '8.1.703', '8.2.706', '8.2.707', '13.1.701', '4.29.4' } } ) 
  else
...
function DDS_arr_issled( mdata )
  ...
  default mdata to 0d20250801 // temporary
...
// 01.10.25
function dds_arr_osm1_new( mdata, mobil )
  ...
  dds_osm1 := {}
  if mdata >= 0d20250901
    AAdd( dds_osm1, { '2.94.21', ' ', 'пульмонолог', { 75 }, { 113413, 112208, 112501 } } )
    AAdd( dds_osm1, { '2.94.22', ' ', 'дерматовенеролог', { 16 }, { 1104 } } )
    AAdd( dds_osm1, { '2.94.23', ' ', 'ревматолог', { 77 }, { 113414, 112209 } } )
    AAdd( dds_osm1, { '2.94.24', ' ', 'аллерголог-иммунолог', { 4 }, { 113405, 112214 } } )
    AAdd( dds_osm1, { '2.94.25', ' ', 'детский кардиолог', { 17 }, { 113403 } } )
    AAdd( dds_osm1, { '2.94.26', ' ', 'гастроэнтеролог', { 11 }, { 113407, 112201 } } )
    AAdd( dds_osm1, { '2.94.27', ' ', 'нефролог', { 56 }, { 113412, 112207 } } )
    AAdd( dds_osm1, { '2.94.28', ' ', 'гематолог', { 12 }, { 113408, 112202 } } )
    AAdd( dds_osm1, { '2.94.29', ' ', 'инфекционист', { 28 }, { 1106 } } )
    AAdd( dds_osm1, { '2.94.30', ' ', 'детский онколог', { 18 }, { 113401, 112801, 113501 } } )
    AAdd( dds_osm1, { '2.94.31', ' ', 'нейрохирург', { 54 }, { 112602, 113504 } } )
    AAdd( dds_osm1, { '2.94.32', ' ', 'колопроктолог', { 30 }, { 112601, 113503 } } )
    AAdd( dds_osm1, { '2.94.33', ' ', 'сердечно-сосудистый хирург', { 81 }, { 112604, 113505 } } )
    if mobil == 0
      AAdd( dds_osm1, { '70.6.103', ' ', 'офтальмолог', { 65 }, { 1112 } } )
      AAdd( dds_osm1, { '70.6.106', ' ', 'оториноларинголог', { 162, 64 }, { 1111, 111101 } } )
      AAdd( dds_osm1, { '70.6.102', ' ', 'детский хирург', { 20 }, { 1135 } } )
      AAdd( dds_osm1, { '70.6.105', ' ', 'травматолог-ортопед', { 100 }, { 1123 } } )
      AAdd( dds_osm1, { '70.6.107', 'Ж', 'акушер-гинеколог (девочки)', { 136, 2 }, { 1101 } } )
...
//    AAdd( dds_osm2, { 'педиатр', { 68, 57 }, { 1134, 1110 }, { '2.83.14', '2.83.15' } } )
    if mobil == 0
      ...
      AAdd( dds_osm1, { '2.83.22', ' ', 'оториноларинголог', { 162, 64 }, { 1111, 111101 } } )
      AAdd( dds_osm1, { '2.83.18', ' ', 'детский хирург', { 20 }, { 1135 } } )
      AAdd( dds_osm1, { '2.83.19', ' ', 'травматолог-ортопед', { 100 }, { 1123 } } )
      AAdd( dds_osm1, { '2.83.16', 'Ж', 'акушер-гинеколог (девочки)', { 136, 2 }, { 1101 } } )
...
function dds_arr_osm2( mdata )
  ...
  dds_osm2 := {}
  if mdata >= 0d20250901
    AAdd( dds_osm2, { 'пульмонолог', '', 0, 17, { 75 }, { 113413, 112208, 112501 }, { '2.94.21' } } )
    AAdd( dds_osm2, { 'дерматовенеролог', '', 0, 17, { 16 }, { 1104 }, { '2.94.22' } } )
    AAdd( dds_osm2, { 'ревматолог', '', 0, 17, { 77 }, { 113414, 112209 }, { '2.94.23' } } )
    AAdd( dds_osm2, { 'аллерголог-иммунолог', '', 0, 17, { 4 }, { 113405, 112214 }, { '2.94.24' } } )
    AAdd( dds_osm2, { 'детский кардиолог', '', 0, 17, { 17 }, { 113403 }, { '2.94.25' } } )
    AAdd( dds_osm2, { 'гастроэнтеролог', '', 0, 17, { 11 }, { 113407, 112201 }, { '2.94.26' } } )
    AAdd( dds_osm2, { 'нефролог', '', 0, 17, { 56 }, { 113412, 112207 }, { '2.94.27' } } )
    AAdd( dds_osm2, { 'гематолог', '', 0, 17, { 12 }, { 113408, 112202 }, '2.94.28' } )
    AAdd( dds_osm2, { 'инфекционист', '', 0, 17, { 28 }, { 1106 }, { '2.94.29' } } )
    AAdd( dds_osm2, { 'детский онколог', '', 0, 17, { 18 }, { 113401, 112801, 113501 }, '2.94.30' } )
    AAdd( dds_osm2, { 'нейрохирург', '', 0, 17, { 54 }, { 112602, 113504 }, { '2.94.31' } } )
    AAdd( dds_osm2, { 'колопроктолог', '', 0, 17, { 30 }, { 112601, 113503 }, { '2.94.32' } } )
    AAdd( dds_osm2, { 'сердечно-сосудистый хирург', '', 0, 17, { 81 }, { 112604, 113505 }, { '2.94.33' } } )
