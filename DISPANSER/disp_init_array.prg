...
function np_arr_1_etap( mdata )
  ...
  if mdata >= 0d20250901  // после 01 сентбря 25 года
    ...
    AAdd( arr_PN_1_etap, { 13, { 1, 0 }, { 1, 1 }, ;
      { '2.87.50', '2.87.51', '2.87.52', '2.87.55', '2.87.53' }, ;
    ...
    AAdd( arr_PN_1_etap, { 17, { 2, 11 }, { 4, 0 }, ;
      { '2.87.50', '2.87.51', '2.87.52', '2.87.53', '2.87.55' }, ;
      { '4.2.753', '4.11.736' } } )
    ...
    AAdd( arr_PN_1_etap, { 20, { 6, 0 }, { 7, 0 }, ;
      { '2.87.50', '2.87.51', '2.87.53', '2.87.54', '2.87.52', '2.87.55', '2.4.1', '2.87.56', '2.87.57', '2.87.58' }, ;
      { '4.2.753', '4.11.736', '8.2.701', '8.1.703', '8.1.706', '13.1.701', '13.2.1', '4.29.2' } } )
    AAdd( arr_PN_1_etap, { 21, { 7, 0 }, { 8, 0 }, ;
      { '2.87.50', '2.87.53', '2.87.52' }, ;
      {} } )
    ...
    AAdd( arr_PN_1_etap, { 24, { 10, 0 }, { 11, 0 }, ;
      { '2.87.50', '2.87.53', '2.87.58', '2.87.51', '2.87.52' }, ;
      { '4.2.753', '4.11.736', '4.29.2' } } )
    AAdd( arr_PN_1_etap, { 25, { 11, 0 }, { 12, 0 }, ;
      { '2.87.53' }, ;
      {} } )
    AAdd( arr_PN_1_etap, { 26, { 12, 0 }, { 13, 0 }, ;
      { '2.87.53', '2.4.1', '2.87.54' }, ;
      {} } )
    AAdd( arr_PN_1_etap, { 27, { 13, 0 }, { 14, 0 }, ;
      { '2.87.53', '2.87.57', '2.87.56', '2.87.52' }, ;
      {} } )
    AAdd( arr_PN_1_etap, { 28, { 14, 0 }, { 15, 0 }, ;
      { '2.85.51', '2.4.1', '2.87.57', '2.87.56', '2.87.53' }, ;
      {} } )
    AAdd( arr_PN_1_etap, { 29, { 15, 0 }, { 16, 0 }, ;
      { '2.87.51', '2.87.53', '2.87.57', '2.87.56', '2.87.58', '2.87.50', '2.87.54', '2.87.52', '2.87.55', '2.4.1' }, ;
      { '4.2.753', '4.11.736', '8.2.701', '8.1.706', '13.1.701' } } )
    AAdd( arr_PN_1_etap, { 30, { 16, 0 }, { 17, 0 }, ;
      { '2.87.51', '2.87.53', '2.87.50', '2.87.52', '2.87.57', '2.87.56', '2.4.1' }, ;
      { '4.2.753', '4.11.736' } } )
    AAdd( arr_PN_1_etap, { 31, { 17, 0 }, { 18, 0 }, ;
      { '2.87.51', '2.87.53', '2.87.58', '2.87.50', '2.87.54', '2.87.52', '2.87.55', '2.87.57', '2.87.56', '2.4.1' }, ;
...
function np_arr_issled( mdata )
  ...
  if mdata >= 0d20250901
//      { '4.26.100',   , 'неонатальный скрининг на врожденные или наследственные заболевания', 0, 34, { 1107, 1301, 1402, 1702, 1801, 2011, 2013 } }, ;
    arr_PN_issled := { ;
      ...
      { '13.2.1',   , 'исследование вызванное отоакустической эмиссией', 0, 111, { 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202, 2021 } }, ;
      { '13.2.2',   , 'офтальмоскопия в услових мидриаза', 0, 111, { 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202, 2021 } } ;
    }
  else
    arr_PN_issled := { ;
...
// 22.09.25
function np_arr_osmotr( mdata )

  local arr_PN_osmotr

  if mdata >= 0d20250901
    arr_PN_osmotr := { ;
      { '2.94.1' ,   , 'пульмонолог', 75, { 113413, 112208, 112501 } }, ;
      { '2.94.2' ,   , 'дерматовенеролог', 16, { 1104 } }, ;
      { '2.94.3' ,   , 'ревматолог', 77, { 113414, 112209 } }, ;
      { '2.94.4' ,   , 'аллерголог-иммунолог', 4, { 113405, 112214 } }, ;
      { '2.94.5' ,   , 'кардиолог', 17, { 113403 } }, ;
      { '2.94.6' ,   , 'гастроэнтеролог', 11, { 113407, 112201 } }, ;
      { '2.94.7' ,   , 'нефролог', 56, { 113412, 112207 } }, ;
      { '2.94.8' ,   , 'гематолог', 12, { 113408, 112202 } }, ;
      { '2.94.9' ,   , 'инфекционист', 28, { 1106 } }, ;
      { '2.94.10',   , 'детский онколог', 18, { 113401, 112801, 113501 } }, ;
      { '2.94.11',   , 'нейрохирург', 54, { 112602, 113504 } }, ;
      { '2.94.12',   , 'колопроктолог', 30, { 112601, 113503 } }, ;
      { '2.94.13',   , 'сердечно-сосудистый хирург', 81, { 112604, 113505 } }, ;
      { '2.87.56','Ж', 'акушер-гинеколог', 136, { 1101 } }, ;
      { '2.87.57','М', 'детский уролог-андролог', 19, { 112603, 113502 } }, ;
      { '2.87.51',   , 'детский хирург', 20, { 1135 } }, ;
      { '2.87.54',   , 'травматолог-ортопед', 100, { 1123 } }, ;
      { '2.87.50',   , 'невролог', 53, { 1109 } }, ;
      { '2.87.52',   , 'офтальмолог', 65, { 1112 } }, ;
      { '2.87.55',   , 'отоларинголог', 162, { 1111, 111101 } }, ;
      { '2.87.53',   , 'детский стоматолог', 86, { 1401, 140102 } }, ;
      { '2.87.58',   , 'детский эндокринолог', 21, { 1127, 112702, 113402 } }, ;
...
// 21.09.25
function np_arr_not_zs()
  
  local arr_not_zs 
  
  arr_not_zs := { ;  // замена на услуги с ценой (нет законченного случая)
    { '3.5.4',   '3.5.704', }, ;//
    { '4.2.153', '4.2.753', }, ;//
    { '4.11.136', '4.11.736', }, ;//
    { '8.1.1',   '8.1.701', }, ;//
