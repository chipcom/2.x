  ...
  do while .t.
    ...
    elseif num_screen == 2 //
      ...
      @ j,col()+1 say "к специалистам" get ma_mo_spec ;
                 ...
                 when m1napr_v_mo > 0
      // @ j,col()+5 say "Врач" get mtab_v_mo pict "99999" valid {|g| v_kart_vrach(g) } when m1napr_v_mo > 0
      ...
      @ j,col()+1 say "по профилю" get mprofil_stac ;
                 ...
                 when m1napr_stac > 0
      // @ j,col()+5 say "Врач" get mtab_v_stac pict "99999" valid {|g| v_kart_vrach(g) } when m1napr_stac > 0
