  ...
  if mdata >= 0d20250901  // после 01 сентбря 25 года
    ...
    if mdata >= 0d20260101
      AAdd( arr_PN_1_etap, { 13, { 1, 0 }, { 1, 1 }, ;
        ...
        { '4.2.753', '4.11.736', '13.1.701', '13.2.100', '13.2.101' } } )
    else
      AAdd( arr_PN_1_etap, { 13, { 1, 0 }, { 1, 1 }, ;
        iif( mobil == 0, { '2.94.2', '2.94.3', '2.94.4', '2.94.7', '2.94.5' }, ;
          { '2.94.12', '2.94.13', '2.94.14', '2.94.17', '2.94.15' } ), ;
    ...
    if mdata >= 0d20260101
      AAdd( arr_PN_1_etap, { 20, { 6, 0 }, { 7, 0 }, ;
        ...
        { '4.2.753', '4.11.736', '8.2.701', '8.1.703', '8.1.706', '13.1.701', '13.2.100', '4.29.2' } } )
    else
      AAdd( arr_PN_1_etap, { 20, { 6, 0 }, { 7, 0 }, ;
        iif( mobil == 0, { '2.94.2', '2.94.3', '2.94.5', '2.94.6', '2.94.4', '2.94.7', '2.4.1', '2.94.8', '2.94.9', '2.94.10' }, ;
           { '2.94.12', '2.94.13', '2.94.15', '2.94.16', '2.94.14', '2.94.17', '2.4.1', '2.94.18', '2.94.19', '2.94.20' } ), ;
...
function np_arr_issled( mdata )
  ...
  if mdata >= 0d20250901
    arr_PN_issled := { ;
      ...
      if mdata >= 0d20260101
        AAdd( arr_PN_issled, { '13.2.100',   , 'исследование вызванное отоакустической эмиссией', 0, 162, { 1111, 111101 } } )
        AAdd( arr_PN_issled, { '13.2.101',   , 'офтальмоскопия в услових мидриаза', 0, 65, { 1112 } } )
      else
        AAdd( arr_PN_issled, { '13.2.1',   , 'исследование вызванное отоакустической эмиссией', 0, 162, { 1111, 111101 } } )
        AAdd( arr_PN_issled, { '13.2.2',   , 'офтальмоскопия в услових мидриаза', 0, 65, { 1112 } } )
      endif

      AAdd( arr_PN_issled, { '2.4.2',   , 'скрининг на выявление нарушений психического развития', 0, { 57, 68, 72, 73 }, { 1134, 1115, 111504 } } )
  else
    arr_PN_issled := { ;
...
function np_arr_osmotr( mdata, mobil )
  ...
  if mdata >= 0d20250901
    arr_PN_osmotr := {}
    if mobil == 0   // услуги обычного осмотра
    ...
    else    // осмотр мобильной бригадой
    ...
    if mdata < 0d20260901   // услуги второго этапа
...
function PN_usl_replace( mdata ) // замена на услуги с ценой (нет законченного случая)
  ...
  arr_not_zs := { ;  
    ...
    { '4.29.2',   '4.29.101' }, ;    // исследование уровня холестерина
    ...
    if mdata >= 0d20260101
      // с тарифом, без тарифа
      AAdd( arr_not_zs, { '13.2.100',   '13.2.1' } )  // отоакустическая эмиссия
      AAdd( arr_not_zs, { '13.2.101',   '13.2.2' } )  // офтальмоскопия в условиях мидриаза
    else
      // с тарифом, без тарифа
      AAdd( arr_not_zs, { '13.2.1',   '13.2.100' } )  // отоакустическая эмиссия
      AAdd( arr_not_zs, { '13.2.2',   '13.2.101' } )  // офтальмоскопия в условиях мидриаза
    endif
  if mdata >= 0d20250901
    AAdd( arr_not_zs, { '2.94.2', '2.3.9' } )   // невролог
    AAdd( arr_not_zs, { '2.94.3', '2.3.10' } )   // детский хирург
    AAdd( arr_not_zs, { '2.94.4', '2.3.11' } )   // офтальмолог
    AAdd( arr_not_zs, { '2.94.5', '2.3.12' } )   // детский стоматолог
    AAdd( arr_not_zs, { '2.94.6', '2.3.13' } )   // травматолог-ортопед
    AAdd( arr_not_zs, { '2.94.7', '2.3.14' } )   // отоларинголог
    AAdd( arr_not_zs, { '2.94.8', '2.3.15' } )    // акушер-гинеколог
    AAdd( arr_not_zs, { '2.94.9', '2.3.16' } )    // детский уролог-андролог
    AAdd( arr_not_zs, { '2.94.10', '2.3.17' } )   // детский эндокринолог
    AAdd( arr_not_zs, { '2.94.12', '2.3.9' } )   // невролог
    AAdd( arr_not_zs, { '2.94.13', '2.3.10' } )   // детский хирург
    AAdd( arr_not_zs, { '2.94.14', '2.3.11' } )   // офтальмолог
    AAdd( arr_not_zs, { '2.94.15', '2.3.12' } )   // детский стоматолог
    AAdd( arr_not_zs, { '2.94.16', '2.3.13' } )   // травматолог-ортопед
    AAdd( arr_not_zs, { '2.94.17', '2.3.14' } )   // отоларинголог
    AAdd( arr_not_zs, { '2.94.18', '2.3.15' } )   // акушер-гинеколог
    AAdd( arr_not_zs, { '2.94.19', '2.3.16' } )   //детский уролог-андролог
    AAdd( arr_not_zs, { '2.94.20', '2.3.17' } )  // детский эндокринолог
  endif
  return arr_not_zs
...
function proverka_otkaza_new( d, arr_otkaz, lshifr )
  ...
  if ( kk := AScan( arr_otkaz, {| x| AllTrim( x[ 5 ] ) == lshifr } ) ) > 0
    lRet := .t.
  endif
  return lRet
