...
// 04.03.26 массивы по диспансеризации репродуктивного здоровья
Function ret_array_drz( mdate )

  default mdate to 0d20260101
  
  Return iif( mdate >= 0d20260101, array_drz_2026(), array_drz_before_2026() )

// 04.03.26
function array_drz_2026()
  ...
  // 15 - массив для меню результатов
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        'B01.001.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A01.20.002', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A02.20.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A01.20.003', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A01.20.005', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A01.20.006', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A09.20.011', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A12.20.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
//        { 136, 151 }, ; // V002 - классификатор профилей оказанной мед. помощи
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A08.20.017', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A08.20.017.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 3 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A08.20.017.002', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 3 ) ; // меню результатов исследования
      } ;
    )
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A26.20.009.002', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'B01.053.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 2021, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'B01.057.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 1 ) ; // меню результатов исследования
      } ;
    )
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 33, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A04.21.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 2 ) ; // меню результатов исследования
      } ;
    )
    ...
    AAdd( arr_drz_usl, ;
      { ;
        ...
        { 13, 110103, 110303, 110906, 111006, 111905, 112212, 112611, 113418, 113509, 180202 }, ; // V004 классификатор мед. специальностей
        0, ;  // признак услуги ТФОМС/ФФОМС 0 - ТФОМС, 1 - ФФОМС
        'A26.21.035.001', ;   // соответствующая услуга ФФОМС услуге ТФОМС
        1, ; // показывать в меню - 1, нет - 0
        drz_result_drz( 2 ) ; // меню результатов исследования
      } ;
    )
...
// 04.03.26
function array_drz_before_2026()
